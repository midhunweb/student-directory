...
public class GradePoint {
    static String phyGradePoint(float phy) {
        String pgp = null;
    ...
    static String cheGradePoint(float che) {
        String cgp = null;
        if (che > 90 && che <= 100) {
    ...
    static String mathGradePoint(float math) {
        String mgp = null;
        if (math > 90 && math <= 100) {
